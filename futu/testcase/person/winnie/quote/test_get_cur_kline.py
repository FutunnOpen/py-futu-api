...
class GetCurKline(unittest.TestCase):
    ...
    def step_check_base1(self, casename, code, num, ktype, autype):
        ...
        # print(ktype)
        # print(num)
        print(quote_ctx1.subscribe(code, ktype))
...
#         #订阅所有类型的K线
#         subtypes = [SubType.K_1M, SubType.K_3M, SubType.K_5M, SubType.K_15M, SubType.K_60M, SubType.K_DAY, SubType.K_WEEK, SubType.K_MON, SubType.K_QUARTER, SubType.K_YEAR]
...
if __name__ == '__main__':
    ...
    # unittest.main()
    gck = GetCurKline()
    gck.test_get_cur_kline_hk_mon()
    # gck.test_get_cur_kline_us_1m()
    # gck.test_get_cur_kline_hk_idx_3m()
    # gck.test_get_cur_kline_hk_60m()
    # print(quote_ctx1.subscribe('HK.00700','K_3M'))
