...
class TradeUS(object):
    ...
    def test_plateOrder_noPush(self):
        ...
        trade_us = OpenUSTradeContext('127.0.0.1',11112)
        # trade_us_2 = OpenUSTradeContext('172.18.7.65',11111)
        #日志
        logger = self.getNewLogger('plate_order_time_out_100068')
        logger2 = self.getNewLogger('mac_11111(2)')
        #解锁交易
        ...
        for index in range(len(codes)):
            ...
            logger2.info(trade_us_2.position_list_query(code='', pl_ratio_min=None, pl_ratio_max=None, trd_env=TrdEnv.REAL,
    ...
    def test_plate_order_noPush_timing(self):
        start_time = datetime.datetime( 2018, 10, 11, 21, 1, 1)
