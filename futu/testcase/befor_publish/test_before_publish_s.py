...
class Log(object):
    def get_logger(self, fName):
        ...
        log_abs_name = os.getcwd() + os.path.sep + 'log' + os.path.sep + os.path.sep + fName + str(
            (int)(time.time())) + '.txt'
...
class BeforePublishTest(object):
    ...
    def test_quotation(self):
        ...
        # logger.info(
        #     quote_ctx.get_history_kline(code='HK.00700', start=None, end=None, ktype=KLType.K_DAY, autype=AuType.QFQ,
        #                                 fields=[KL_FIELD.ALL]))
        # logger.info(
        ...
        # logger.info(quote_ctx.get_multi_points_history_kline(code_list=['HK.00700', 'US.JD', 'SH.000001'],
        ...
        # subTypes = [SubType.K_1M, SubType.K_3M, SubType.K_DAY]
    ...
    def test_trade(self, tradeEnv=TrdEnv.REAL):
        ...
        for order_id_hk in order_ids_hk:
            ...
            logger.info(
                trade_hk.modify_order(modify_order_op=ModifyOrderOp.NORMAL, order_id=order_id_hk, qty=qty_hk * 2,
            ...
            logger.info(
                trade_hk.modify_order(modify_order_op=ModifyOrderOp.CANCEL, order_id=order_id_hk, qty=0, price=0,
                                      adjust_limit=0,
                                      trd_env=tradeEnv, acc_id=0))
        ...
        for order_id_us in order_ids_us:
            ...
            logger.info(
                trade_us.modify_order(modify_order_op=ModifyOrderOp.NORMAL, order_id=order_id_us, qty=qty_us * 2,
            ...
            logger.info(
                trade_us.modify_order(modify_order_op=ModifyOrderOp.CANCEL, order_id=order_id_us, qty=0, price=0,
                                      adjust_limit=0,
                                      trd_env=tradeEnv, acc_id=0))
        ...
        for order_id_cn in order_ids_cn:
            ...
            logger.info(
                trade_cn.modify_order(modify_order_op=ModifyOrderOp.NORMAL, order_id=order_id_cn, qty=qty_cn * 2,
            ...
            logger.info(
                trade_cn.modify_order(modify_order_op=ModifyOrderOp.CANCEL, order_id=order_id_cn, qty=0, price=0,
                                      adjust_limit=0,
                                      trd_env=tradeEnv, acc_id=0))
