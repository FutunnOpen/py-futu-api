...
_S2C = _descriptor.Descriptor(
  name='S2C',
  full_name='Qot_UpdateKL.S2C',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rehabType', full_name='Qot_UpdateKL.S2C.rehabType', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='klType', full_name='Qot_UpdateKL.S2C.klType', index=1,
...
_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='retType', full_name='Qot_UpdateKL.Response.retType', index=0,
      number=1, type=5, cpp_type=1, label=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='retMsg', full_name='Qot_UpdateKL.Response.retMsg', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='errCode', full_name='Qot_UpdateKL.Response.errCode', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='s2c', full_name='Qot_UpdateKL.Response.s2c', index=3,
