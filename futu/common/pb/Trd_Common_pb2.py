...
_CLTRISKLEVEL = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='CltRiskLevel_Safe', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CltRiskLevel_Warning', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CltRiskLevel_Danger', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CltRiskLevel_AbsoluteSafe', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CltRiskLevel_OptDanger', index=4, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
