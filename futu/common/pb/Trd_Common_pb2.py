...
_TIMEINFORCE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='TimeInForce_Unknown', index=0, number=-1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TimeInForce_DAY', index=1, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TimeInForce_GTC', index=2, number=1,
      options=None,
      type=None),
  ],
  containing_type=None,
