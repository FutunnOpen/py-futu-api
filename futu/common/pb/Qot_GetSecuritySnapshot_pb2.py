...
_PREAFTERMARKETDATA = _descriptor.Descriptor(
  ...
  full_name='Qot_GetSecuritySnapshot.PreAfterMarketData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='price', full_name='Qot_GetSecuritySnapshot.PreAfterMarketData.price', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='highPrice', full_name='Qot_GetSecuritySnapshot.PreAfterMarketData.highPrice', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lowPrice', full_name='Qot_GetSecuritySnapshot.PreAfterMarketData.lowPrice', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='volume', full_name='Qot_GetSecuritySnapshot.PreAfterMarketData.volume', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='turnover', full_name='Qot_GetSecuritySnapshot.PreAfterMarketData.turnover', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='changeVal', full_name='Qot_GetSecuritySnapshot.PreAfterMarketData.changeVal', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='changeRate', full_name='Qot_GetSecuritySnapshot.PreAfterMarketData.changeRate', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='amplitude', full_name='Qot_GetSecuritySnapshot.PreAfterMarketData.amplitude', index=7,
...
PreAfterMarketData = _reflection.GeneratedProtocolMessageType('PreAfterMarketData', (_message.Message,), dict(
  ...
  __module__ = 'Qot_GetSecuritySnapshot_pb2'
  # @@protoc_insertion_point(class_scope:Qot_GetSecuritySnapshot.PreAfterMarketData)
  ))
