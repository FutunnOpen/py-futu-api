...
_CNIPOEXDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='winningName', full_name='Qot_GetIpoList.CNIpoExData.winningName', index=16,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='winningInfo', full_name='Qot_GetIpoList.CNIpoExData.winningInfo', index=17,
