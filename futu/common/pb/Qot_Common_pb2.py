...
_SORTFIELD = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SortField_PreCurPrice', index=35, number=35,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SortField_AfterCurPrice', index=36, number=36,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SortField_PrePriceChangeVal', index=37, number=37,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SortField_AfterPriceChangeVal', index=38, number=38,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SortField_PreChangeRate', index=39, number=39,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SortField_AfterChangeRate', index=40, number=40,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SortField_PreAmplitude', index=41, number=41,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SortField_AfterAmplitude', index=42, number=42,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SortField_PreTurnover', index=43, number=43,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SortField_AfterTurnover', index=44, number=44,
      options=None,
      type=None),
  ],
  containing_type=None,
