...
_FINANCIALFIELD = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialField_Turnover', index=4, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialField_TurnoverGrowth', index=5, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
