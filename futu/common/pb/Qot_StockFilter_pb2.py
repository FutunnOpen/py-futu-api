...
_ACCUMULATEFIELD = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AccumulateField_ChangeVal', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AccumulateField_Amplitude', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AccumulateField_Volume', index=4, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AccumulateField_Turnover', index=5, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AccumulateField_TurnoverRate', index=6, number=6,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_FINANCIALFIELD = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialField_GrossProfit', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialField_GrossProfitGrowth', index=4, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialField_Turnover', index=5, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialField_TurnoverGrowth', index=6, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialField_NetProfitRate', index=7, number=7,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialField_GrossProfitRate', index=8, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialField_DebtAssetRate', index=9, number=9,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialField_ReturnOnEquityRate', index=10, number=10,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_FINANCIALQUARTER = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialQuarter_Latest', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialQuarter_SixQuarter', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialQuarter_NineQuarter', index=4, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
...
AccumulateField_ChangeVal = 2
AccumulateField_Amplitude = 3
AccumulateField_Volume = 4
AccumulateField_Turnover = 5
AccumulateField_TurnoverRate = 6
FinancialField_Unknown = 0
FinancialField_NetProfit = 1
FinancialField_NetProfitGrowth = 2
FinancialField_GrossProfit = 3
FinancialField_GrossProfitGrowth = 4
FinancialField_Turnover = 5
FinancialField_TurnoverGrowth = 6
FinancialField_NetProfitRate = 7
FinancialField_GrossProfitRate = 8
FinancialField_DebtAssetRate = 9
FinancialField_ReturnOnEquityRate = 10
FinancialQuarter_Unknown = 0
FinancialQuarter_Annual = 1
FinancialQuarter_Latest = 2
