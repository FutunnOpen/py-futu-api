...
_FINANCIALFIELD = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FinancialField_NetProfitCashCover', index=19, number=19,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
