...
_C2S = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='positionID', full_name='Trd_PlaceOrder.C2S.positionID', index=18,
